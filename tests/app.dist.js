...
var Core = /*#__PURE__*/function () {
  ...
  function Core() {
    ...
    _defineProperty(this, "onClick", function (e) {
      if (!(e.metaKey || e.ctrlKey)) {
        ...
        if (_this.currentLocation.href !== target.href || _this.currentLocation.hasHash && !target.hasHash) {
          ...
          _this.navigateTo(target.raw, e.currentTarget.dataset.transition || false, e.currentTarget);
    ...
    var _parameters$links = parameters.links,
        ...
        _parameters$removeOld = parameters.removeOldContent,
  ...
  _createClass(Core, [{
    ...
    value: function preload(url) {
      ...
      if (!this.cache.has(url)) {
        return this.fetch(url).then( /*#__PURE__*/function () {
    ...
    value: function updateCache() {
      var key = (0,_helpers__WEBPACK_IMPORTED_MODULE_2__.processUrl)(window.location.href).href;
    ...
    value: function clearCache(url) {
      var key = (0,_helpers__WEBPACK_IMPORTED_MODULE_2__.processUrl)(url || window.location.href).href;
    ...
    value: function navigateTo(url) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this3.targetLocation = (0,_helpers__WEBPACK_IMPORTED_MODULE_2__.processUrl)(url);
    ...
    value: function beforeFetch(url, TransitionClass, trigger) {
      ...
      return new Promise(function (resolve) {
        _this4.currentCacheEntry.renderer.leave(TransitionClass, trigger, _this4.removeOldContent).then(function () {
          if (trigger !== 'popstate') {
...
var Renderer = /*#__PURE__*/function () {
  ...
  _createClass(Renderer, [{
    ...
    key: "leave",
    value: function leave(transition, trigger, removeOldContent) {
      var _this2 = this;
...
_unseenco_e__WEBPACK_IMPORTED_MODULE_0__["default"].on('DOMContentLoaded', window, function () {
  ...
  _unseenco_e__WEBPACK_IMPORTED_MODULE_0__["default"].delegate('click', '#add-content', function () {
    var target = document.getElementById('extra-content');
    var p = document.createElement("p");
    p.append('some text');
    target.append(p);
  });
  _unseenco_e__WEBPACK_IMPORTED_MODULE_0__["default"].delegate('click', '#update-cache', function () {
    taxi.updateCache();
  });
  _unseenco_e__WEBPACK_IMPORTED_MODULE_0__["default"].delegate('click', '#clear-cache', function () {
    taxi.clearCache();
  });
});
})();
